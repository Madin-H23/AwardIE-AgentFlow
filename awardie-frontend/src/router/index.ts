  ...
  routes: [
    ...
    { path: '/change-password', name: 'change-password', component: () => import('../views/ChangePasswordView.vue') },
    {
      ...
      children: [
        ...
        { path: 'admin/templates/create', name: 'admin-template-create', component: () => import('../views/TemplatesCreateView.vue') },
        { path: 'admin/templates/:id/detail', name: 'admin-template-detail', component: () => import('../views/TemplatesDetailView.vue') },
