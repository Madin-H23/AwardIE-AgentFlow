...
CREATE TABLE "achievement_audit_log" (
            ...
            created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP, is_redundant BOOLEAN NOT NULL DEFAULT false, is_test BOOLEAN NOT NULL DEFAULT false);
...
CREATE TABLE "award_related_students" (award_id INTEGER, student_id INTEGER, created_at TIMESTAMPTZ);
CREATE TABLE "award_student_winners" (award_id INTEGER, student_id INTEGER, created_at TIMESTAMPTZ);
...
CREATE TABLE "laboratory_images" (
                    ...
                    display_order INTEGER DEFAULT 0,
                    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP, file_name VARCHAR(100), file_hash VARCHAR(64), description TEXT, submitter_type VARCHAR(20), submitter_id INTEGER
                );
